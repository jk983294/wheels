...
TEST_CASE("FaultInjection FaultTestNoLogReuse", "[FaultInjection]") {
  FaultInjectionTest test;
  test.ReuseLogs(false);
  test.DoTest();
}
TEST_CASE("FaultInjection FaultTestWithLogReuse", "[FaultInjection]") {
  FaultInjectionTest test;
  test.ReuseLogs(true);
  test.DoTest();
}
